...
class CustomImageWrapper extends StatefulWidget {
  ...
  @override
  _CustomImageWrapperState createState() => _CustomImageWrapperState();
}

class _CustomImageWrapperState extends State<CustomImageWrapper> {
  ImageStreamListener? _imageStreamListener;
  ImageStream? _imageStream;
  ImageChunkEvent? _loadingProgress;
  ImageInfo? _imageInfo;
  ...
  @override
  void didUpdateWidget(CustomImageWrapper oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.imageProvider != oldWidget.imageProvider) {
      _resolveImage();
    }
  ...
  Widget build(BuildContext context) {
    ...
    return PhotoViewCore.customImage(
      imageProvider: widget.imageProvider,
